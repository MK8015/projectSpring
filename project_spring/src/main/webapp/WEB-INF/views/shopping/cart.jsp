...
$(document).ready(function() {
	...
	$(".cartUpdate").click(function(e){
		e.preventDefault();
// 		console.log("변경클릭");
		var product_id = $(".chkbox").attr("data-productId");
		var update_cart_amount = parseInt($("#cart_amount").val());
// 		console.log(update_cart_amount);
		$(this).location("href","/spring/cart/update");
	});
